...
import 'package:login_page/controllers/registration_controller.dart';
import 'package:login_page/screens/auth/widgets/input_fields.dart';
import 'package:login_page/screens/auth/widgets/submit_button.dart';
  ...
  Widget registerWidget() {
    return Column(
      children: [
        ...
        SubmitButton(
          onPressed: () => registerationController.regiterWithEmail(),
          title: 'Register',
        )
      ],
    );
